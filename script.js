...
const handleUser = (id) => {
  ...
  data = data.filter((transaction) => transaction.id !== currentlySelectedTransaction.id);
...
const displayUsers = (user) => {
  ...
  console.log(users)
  // Append users at the end of div
  document.getElementById('users').innerHTML += usersData;
}
